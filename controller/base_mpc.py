...
class BaseMPC(ABC):
    ...
    def configure(self, config):
        self.num_directions = config.getint('mpc_env', 'num_directions')
        self.num_linear = config.getint('mpc_env', 'num_linear')
        self.num_angular = config.getint('mpc_env', 'num_angular')
        
        self.gamma = config.getfloat('mpc_env', 'gamma')
        
        self.max_speed = config.getfloat('simulator', 'max_speed')
