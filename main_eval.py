...
if __name__ == "__main__":
    ...
    if len(args.rl_model_weight) > 0:
        path_to_checkpoint = args.rl_model_weight
    ...
    # for case_id_index in range(500):
        # case_id = random.choice(sim.case_id_list) ### randomly sample a case id from the case id list
        ...
        while not done:
            ...
            rl_actions = rl_agent.get_action(torch.FloatTensor(rl_obs).to(device), with_exploration=False)
